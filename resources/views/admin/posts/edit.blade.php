...
<div class="card"><div class="card-body">
    ...
    <form method="POST" action="{{ route('admin.posts.update', $post->id) }}" enctype="multipart/form-data">@csrf @method('PUT')
        ...
        <div class="mb-3"><img src="{{ $post->cover_image ? Storage::url($post->cover_image) : asset('img/service-1.jpg') }}" alt="{{ $post->localized_title }}" class="rounded border" style="width: 80px; height: 80px; object-fit: cover;"></div>
        <div class="row">
