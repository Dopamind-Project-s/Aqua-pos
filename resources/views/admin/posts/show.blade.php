...
<div class="card"><div class="card-body">
    ...
    <div class="mb-3">
        <img src="{{ $post->cover_image ? Storage::url($post->cover_image) : asset('img/service-1.jpg') }}" alt="{{ $post->title }}" class="rounded border" style="width: 180px; height: 180px; object-fit: cover;">
    </div>
    ...
    <div class="mt-3">
        ...
        <h6>Content</h6>
        <p class="mb-0" style="white-space: pre-line;">{{ $post->content }}</p>
    </div>
</div></div>
@endsection
