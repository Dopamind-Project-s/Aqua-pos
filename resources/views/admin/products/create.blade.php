...
<div class="card"><div class="card-body">
    ...
    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">@csrf
        <div class="row g-3">
            ...
            <div class="col-md-4"><label class="form-label">Name (Default)</label><input name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required>@error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
            <div class="col-md-4"><label class="form-label">Name (AR)</label><input name="name_ar" class="form-control @error('name_ar') is-invalid @enderror" value="{{ old('name_ar') }}">@error('name_ar')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
            <div class="col-md-4"><label class="form-label">Name (EN)</label><input name="name_en" class="form-control @error('name_en') is-invalid @enderror" value="{{ old('name_en') }}">@error('name_en')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>

            <div class="col-md-4"><label class="form-label">Tagline (Default)</label><input name="tagline" class="form-control" value="{{ old('tagline') }}"></div>
            <div class="col-md-4"><label class="form-label">Tagline (AR)</label><input name="tagline_ar" class="form-control" value="{{ old('tagline_ar') }}"></div>
            <div class="col-md-4"><label class="form-label">Tagline (EN)</label><input name="tagline_en" class="form-control" value="{{ old('tagline_en') }}"></div>

            <div class="col-md-4"><label class="form-label">Short Description (Default)</label><input name="short_description" class="form-control" value="{{ old('short_description') }}"></div>
            <div class="col-md-4"><label class="form-label">Short Description (AR)</label><input name="short_description_ar" class="form-control" value="{{ old('short_description_ar') }}"></div>
            <div class="col-md-4"><label class="form-label">Short Description (EN)</label><input name="short_description_en" class="form-control" value="{{ old('short_description_en') }}"></div>
            ...
            <div class="col-md-12"><label class="form-label">Description (Default)</label><textarea name="description" class="form-control" rows="3">{{ old('description') }}</textarea></div>
            ...
            <div class="col-md-6"><label class="form-label">Description (EN)</label><textarea name="description_en" class="form-control" rows="3">{{ old('description_en') }}</textarea></div>
            ...
            <div class="col-md-12"><label class="form-label">Use Cases (Default)</label><textarea name="use_cases" class="form-control" rows="2">{{ old('use_cases') }}</textarea></div>
            ...
            <div class="col-md-6"><label class="form-label">Use Cases (EN)</label><textarea name="use_cases_en" class="form-control" rows="2">{{ old('use_cases_en') }}</textarea></div>
        </div>
