...
<body>
@if (request()->routeIs('admin.categories.*') || request()->routeIs('admin.products.*') || request()->routeIs('admin.posts.*') || request()->routeIs('admin.requests.*') || request()->routeIs('admin.partners.*'))
