...
<div class="container-fluid bg-breadcrumb" data-cms-section="team-hero">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h1 class="text-white display-3 mb-4 wow fadeInDown" data-wow-delay="0.1s" data-cms-key="title">
            {{ dynamic_content("team.team-hero.title.{$locale}", 'Our Team') }}
        </h1>
        <ol class="breadcrumb justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="{{ route('home') }}"><span data-i18n="breadcrumb.home">Home</span></a></li>
            <li class="breadcrumb-item active text-primary" data-cms-key="breadcrumb">
                {{ dynamic_content("team.team-hero.breadcrumb.{$locale}", 'Team') }}
            </li>
        </ol>
    </div>
</div>
