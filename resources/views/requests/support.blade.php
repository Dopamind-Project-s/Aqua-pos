...
@section('content')
<div class="container-fluid bg-breadcrumb"><div class="container text-center py-5" style="max-width: 900px;"><h3 class="text-white display-5 mb-3">Support Request</h3></div></div>
<div class="container py-5">
    ...
    <div class="card p-4 shadow-sm">
        <form method="POST" action="{{ route('requests.store') }}" class="row g-3">@csrf
            ...
            <div class="col-12"><label class="form-label">Support Details</label><textarea class="form-control" name="message" rows="5"></textarea></div>
            <div class="col-12"><button class="btn btn-primary">Submit Support Request</button></div>
        </form>
    </div>
</div>
@endsection
